...
class Events(models.Model):
    ...
    socially_supported_adult = models.PositiveIntegerField(verbose_name='Социально опекаемые взрослые', default=0)
    ...
    free_or_not = models.ForeignKey(FreeOrNot, on_delete=models.CASCADE, null=True, verbose_name='Форма оплаты')
